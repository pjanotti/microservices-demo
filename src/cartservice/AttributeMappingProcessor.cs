...
internal class AttrMappingProcessor : ActivityProcessor
{
  ...
  public override void OnEnd(Activity activity)
  {
    ...
    //   !HasTagValue(activity.Tags, new KeyValuePair<string, string>("error", "true"))        // no error
    // )
    // {
    //   // Change tags
    //   activity.SetTag("db.system", "postgres");
    //   activity.SetTag("db.type", "postgres");
    //   // activity.SetTag("peer.service", externalDatabaseName + ":98321");

    //   // Change Operation
    //   activity.DisplayName = "Query";
